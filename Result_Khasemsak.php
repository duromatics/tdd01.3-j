			...
			<div class="container-fluid" style="background-color:#b95ae2;">
				<div class="row">
					<div class="col-sm4 offset-sm-0">
						<h5>โครงการพัฒนาระบบส่งและจำหน่าย ระยะที่ 1 กฟต.1 (สถานะ : 14/03/62)</h5>	
					</div>
				</div>
			</div>
			...
			<div class="container-fluid" style="background-color:#d49aed;">
				<div class="row">
					<div class="col-xs4 offset-sm-0">
							...
							<B>อนุมัติงานแล้ว : </B> 498.66 วงจร - กม.<br>
							<B>ผลงานสะสม ทั้งโครงการ : </B> 168.62 วงจร - กม.<br>
							<B>ค่าใช้จ่ายหน้างาน ทั้งโครงการ : </B> 47.25 ล้านบาท
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="list-group">
							...
							echo "<B>ค่าใช้จ่ายหน้างานสะสม :</B>".$mnyAct_total. " ล้านบาท";
							$a=0;
							?>
