			...
			<div class="container-fluid" style="background-color:#b95ae2;">
				<div class="row">
					<div class="col-sm4 offset-sm-0">
						<h5>โครงการพัฒนาระบบส่งและจำหน่าย ระยะที่ 1 กฟต.1 (สถานะ : 24/05/62)</h5>	
					</div>
				</div>
			</div>
			...
			<div class="container-fluid" style="background-color:#d49aed;">
				<div class="row">
					<div class="col-xs4 offset-sm-0">
							...
							<B>อนุมัติงานแล้ว : </B> 519.13 วงจร - กม.<br>
							<B>ผลงานสะสม ทั้งโครงการ : </B> 174.31 วงจร - กม.<br>
							<B>ค่าใช้จ่ายหน้างาน ทั้งโครงการ : </B> 51.36 ล้านบาท
					</div>
				</div>
			</div>
